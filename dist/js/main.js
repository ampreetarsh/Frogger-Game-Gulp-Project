...
var bestLevel = document.querySelector('.bestLevel');
...
var enemy2 = new Enemy(0, 150, 75);
var enemy3 = new Enemy(0, 230, 60);
var enemy4 = new Enemy(-800, 130, 90);
...
document.addEventListener('keyup', function (e) {
    ...
    var sweetAlert = document.querySelector('.swal-overlay--show-modal');
    // disables the user to play game when the pop-up alert shows up.
    if (!sweetAlert) player.handleInput(allowedKeys[e.keyCode]);
});
'use strict';
...
var Engine = function (global) {
   ...
   */
  Resources.load(['images/stone-block.png', 'images/water-block.png', 'images/grass-block.png', 'images/enemy-bug.png', 'images/char-pink-girl.png']);
